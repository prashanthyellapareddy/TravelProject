...
@VDM.viewType: #BASIC
define view entity ZAM_PY_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZAM_PY_BOOKING as _Booking on
   $projection.BookingId = _Booking.BookingId and
   $projection.TravelId = _Booking.TravelId
association[1..1] to ZAM_PY_TRAVEL as _Travel on
